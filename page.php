            ...
            <div class="row">
                <div class="large-4 columns">
                    <ul class="side-nav"> 
                        ...
                        <li class='active'><a href="page.php">Page Info</a></li> 
                        <li><a href="unique.php">Unique Visitors</a></li>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php
                                ...
                                {
                                    echo "<tr><td>".$row['pageNo']."</td><td>".$row['pageTitle']."</td><td>".$row['timeSpent'].
                                         "</td><td>".$row['visits']."</td><td>".$row['uniqueVisits']."</td></tr>";
                                }
                            ?>
                        </tbody>
                    </table>
