        ...
        <section>
            <div class="row">
                <div class="large-2 columns">
                    <ul class="side-nav"> 
                        <li><a href="page1.php?source=4">Page One</a></li>  
                        <li><a href="page2.php?source=4">Page Two</a></li> 
                        <li><a href="page3.php?source=4">Page Three</a></li>
                        <li class='active'><a href="page4.php?source=4">Page Four</a></li>
                        <li><a href="page5.php?source=4">Page Five</a></li>
                        <li><a href="page6.php?source=4">Page Six</a></li> 
                        <li><a href="page7.php?source=4">Page Seven</a></li>
                    </ul>
                </div>
                <div class="large-10 columns" style="margin-top: 15px;">
                    <div id="banner">
                        <a href="http://www.google.com" class="adbanner" target="_blank"><img src='image/photo-2-1.jpg'></img></a>        
                    </div>
                </div>
            </div>
        </section>
    ...
    <script>
    	$(document).ready(function(){
            ...
            $(window).unload(function(){
                $.post('timelog.php', {spent: (new Date()).getTime() - starttime, start: starttime, pageNo: 4});
            });
        });
