            ...
            <div class="row">
                <div class="large-4 columns">
                    <ul class="side-nav"> 
                        ...
                        <li class='active'><a href="behavior.php">User Behavior</a></li> 
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php
                                ...
                                {
                                    echo "<tr><td>".$row['uid']."</td><td>".$row['pageNo']."</td><td>".$row['enteredAt'].
                                         "</td><td>".$row['leftAt']."</td><td>".$row['timeSpent']."</td></tr>";
                                }
                            ?>
                        </tbody>
                    </table>
